...
public class GlobalExceptionHandler {
    ...
    public Map<String, String> procesarNotFounfException(ResourceNotFoundException exception){
        Map<String, String> exceptionMessage = new HashMap<>();
        exceptionMessage.put("messahe", "Recurso no encontrado: " + exception.getMessage());
